...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final AlexLibraryAccessors laccForAlexLibraryAccessors = new AlexLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>msal</b> with <b>com.microsoft.identity.client:msal</b> coordinates and
     ...
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getMsal() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("msal");
    }

    /**
     * Group of libraries at <b>alex</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public AlexLibraryAccessors getAlex() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForAlexLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class AlexLibraryAccessors extends SubDependencyFactory {
        private final AlexQrLibraryAccessors laccForAlexQrLibraryAccessors = new AlexQrLibraryAccessors(owner);

        public AlexLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>alex.qr</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AlexQrLibraryAccessors getQr() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAlexQrLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AlexQrLibraryAccessors extends SubDependencyFactory {

        public AlexQrLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>generator</b> with <b>com.github.alexzhirkevich:custom-qr-generator</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getGenerator() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("alex.qr.generator");
        }
    ...
    public static class ComSquareupRetrofit2LibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getRetrofit2() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("com.squareup.retrofit2.retrofit2");
        }
