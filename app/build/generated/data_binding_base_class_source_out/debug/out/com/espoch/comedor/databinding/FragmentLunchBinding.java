...
public final class FragmentLunchBinding implements ViewBinding {
  ...
  private FragmentLunchBinding(@NonNull RelativeLayout rootView, @NonNull ImageView background,
  ...
  public static FragmentLunchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLunchBinding((RelativeLayout) rootView, background, search);
    }
